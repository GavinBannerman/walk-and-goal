...
public class TestRecyclerViewAdapter extends RecyclerView.Adapter<TestRecyclerViewAdapter.GoalViewHolder> {

    List<Goal> goals;
    Context context;

    TestRecyclerViewAdapter(List<Goal> goals, Context context){
        this.goals = goals;
